...
* **Clarté TypeScript :** L'usage de `any` is interdit. Tous les objets financiers (Contributions, Objectifs, Budgets) doivent se conformer aux types déclarés dans `src/types.ts`.
